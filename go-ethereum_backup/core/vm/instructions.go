...
func opAdd(pc *uint64, interpreter *EVMInterpreter, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	...
	//fmt.Println("hhhhjjjj opAdd: " ,x,y,stack.peek())
	return nil, nil
}
...
func opLock(pc *uint64, interpreter *EVMInterpreter, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	//interpreter.evm.StateDB.AddCount()
	...
	fmt.Println("hhhhhhhhhhjjjjjjjjjjjjjjjjj -opLock : receive respond!!!!!", <-com_channel_respond) 
	stack.pop()
