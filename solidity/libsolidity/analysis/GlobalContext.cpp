...
inline vector<shared_ptr<MagicVariableDeclaration const>> constructMagicVariables()
{
	...
	return {
		...
		magicVarDecl("lock", TypeProvider::function(strings{"uint256"}, strings{}, FunctionType::Kind::Lock, false, StateMutability::Pure)),
		magicVarDecl("unlock", TypeProvider::function(strings{"uint256"}, strings{}, FunctionType::Kind::Unlock, false, StateMutability::Pure)),
		magicVarDecl("epc", TypeProvider::function(strings{"uint256"}, strings{}, FunctionType::Kind::EPC, false, StateMutability::Pure)),
